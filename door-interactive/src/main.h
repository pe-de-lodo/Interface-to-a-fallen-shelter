...
// #define FINALE_1ST_DURATION 20000
// #define FINALE_2ND_DURATION 20000

#define SECTION_FLAG    (0b100000000000000)
#define SECTION_DOOR    (0b000011111100010)
#define SECTION_CRACK_L (0b011100000000000)
#define SECTION_CRACK_R (0b000000000011101)
